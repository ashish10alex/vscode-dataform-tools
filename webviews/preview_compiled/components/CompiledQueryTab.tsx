...
const actionTypeBadgeStyles: Record<string, { bg: string; text: string; border: string }> = {
...
const defaultBadgeStyle = { bg: "bg-yellow-100 dark:bg-yellow-900/30", text: "text-yellow-700 dark:text-yellow-300", border: "border-yellow-200 dark:border-yellow-800" };
      ...
      {state.actionTypes && state.actionTypes.length > 0 && (
        <div className="flex flex-wrap items-center gap-2">
          ...
          {state.actionTypes.map((actionType) => {
            const style = actionTypeBadgeStyles[actionType] || defaultBadgeStyle;
            return (
              <span
                key={actionType}
