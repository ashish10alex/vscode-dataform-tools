        ...
        if (sqlxBlockMetadata) {
            ...
            if (type === "incremental" && !skipPreOpsInDryRun) {
                ...
                if (iq?.incrementalPreOpsQuery) {
                    ...
                    const N_p = iq.incrementalPreOpsQuery.split('\n').length;
                    ...
                    const incQueryLines = (iq.incrementalQuery || '').split('\n');
                    ...
                    compiledPreOpsLineCount = N_p + N_inc_preamble - offSet;
                }
            }
