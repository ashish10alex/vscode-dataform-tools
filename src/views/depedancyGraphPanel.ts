...
import { nodeMetadata } from '../assets/nodeMetadata';
...
export function createDependencyGraphPanel(context: vscode.ExtensionContext, viewColumn: vscode.ViewColumn = vscode.ViewColumn.Beside) {
